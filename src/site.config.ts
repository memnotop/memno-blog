...
export const integ: IntegrationUserConfig = {
  ...
  quote: {
    ...
    target: `() => {
      const quotes = ['保持平静，保持向外的爱，活在当下。', '食无求饱，居无求安。','非淡薄无以明志，非宁静无以致远。','自尊而不自大。','持而盈之，不如其已；揣而锐之，不可长保。','自强不息','挫其锐，解其纷，和其光，同其尘。','咕咕嘎嘎。','后其身而身先，外其身而身存。','温故而知新，敦厚以崇礼。 ','如切如磋，如琢如磨。','放下生活中的功利心，虚荣心，不必强求，只是经历过程。']
